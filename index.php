<?php require_once('_header.php'); ?> 
                    ...
                    <div class="row g-0 align-items-center">
                        <div class="col-12 col-sm-12 col-md-12 col-lg-6 row_text">
                            <div class="about-info2 row-text">
                                ...
                                <p>The standard chunk of Lorem Ipsum used since the 1500s is reproduced below for those interested. "de Finibus Bonorum et Malorum" by Cicero reproduced in their 1914 translation by H. Rackham.</p>
                        ...
                        <div class="col-12 col-sm-12 col-md-12 col-lg-6">
                            <img class="about-info-img blur-up lazyload" data-src="assets/images/about/about-info-s1.jpg" src="assets/images/about/about-info-s1.jpg" alt="about" />
                        </div>
                    </div>
                </div>
            </section>
                    ...
                    <div class="productSlider grid-products">
                        ...
                        <div class="item">
                            ...
                            <div class="product-image">
                                <!--Start Product Image-->
                                <a href="<?php echo $row['p_slug']; ?>" class="product-img">
                                    <!--Image-->
                                    <img class="primary blur-up lazyload"
                                        data-src="assets/uploads/<?php echo htmlspecialchars($row['p_featured_photo']); ?>"
                                        src="assets/uploads/<?php echo htmlspecialchars($row['p_featured_photo']); ?>" alt="image" title="" width="800"
                                        height="960" />
                                    <!--End image-->
                                    <!--Hover image-->
                                    ...
                                    <!--End hover image-->
                                    <?php if ($row['p_qty'] == 0): ?>
                                    <span class="sold-out"><span class="rounded"><?php echo $row['p_name']; ?></span></span>
                                    <?php endif; ?>
                                </a>
                                <!--end product image-->
                            ...
                            <div class="product-details ">
                                ...
                                <div class="product-name text-uppercase">
                                    <a href="<?php echo $row['p_slug']; ?>"><?php echo $row['p_name']; ?></a>
                                </div>
                                <!--End Product Name-->
                                <!--Product Price-->
                                <div class="product-price">
                                    ...
                                    <?php endif; ?>
                                    <span class="price">$<?php echo number_format($row['p_current_price'], 2); ?></span>
                                </div>
                                <div class="col-12  mt-3">
                                    <a href="<?php echo $row['p_slug']; ?>" class="btn-primary btn-lg rounded">Learn More...</a>
                                </div>
                            </div>
                            <!--End Product Details-->
                        </div>
                                      ...
                                      <li>
                                         ...
                                         <ul class="col">
                                            ...
                                            foreach ($result1 as $row1) {
                                                ?>
                                            <li><a class="" href="<?php echo $row['p_slug']; ?>"><?php echo $row['p_name']; ?></a>
                                            </li>
                                            <?php
									}
									?>
        ...
        <div class="menubar-mobile d-flex align-items-center justify-content-between d-lg-none">
            <div class="menubar-account menubar-item">
                <a href="<?php if(isset($_SESSION['customer'])) {echo'my-account.php';} else {echo 'login.php';}?>">
            ...
            <div class="menubar-search menubar-item">
                <a href="index.php"><span class="menubar-icon an an-home-l"></span><span
